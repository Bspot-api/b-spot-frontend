...
export const companyControllerRemove = <ThrowOnError extends boolean = false>(options: Options<CompanyControllerRemoveData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<CompanyControllerRemoveResponses, CompanyControllerRemoveErrors, ThrowOnError>({
        url: '/companies/{id}',
        ...options
    });
};
...
export const companyControllerFindOne = <ThrowOnError extends boolean = false>(options: Options<CompanyControllerFindOneData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<CompanyControllerFindOneResponses, CompanyControllerFindOneErrors, ThrowOnError>({
        url: '/companies/{id}',
        ...options
    });
};
...
export const companyControllerUpdate = <ThrowOnError extends boolean = false>(options: Options<CompanyControllerUpdateData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<CompanyControllerUpdateResponses, CompanyControllerUpdateErrors, ThrowOnError>({
        url: '/companies/{id}',
        ...options
    });
};
