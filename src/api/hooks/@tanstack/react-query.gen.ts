...
export const companyControllerRemoveMutation = (options?: Partial<Options<CompanyControllerRemoveData>>): UseMutationOptions<CompanyControllerRemoveResponse, DefaultError, Options<CompanyControllerRemoveData>> => {
    const mutationOptions: UseMutationOptions<CompanyControllerRemoveResponse, DefaultError, Options<CompanyControllerRemoveData>> = {
        mutationFn: async (localOptions) => {
